...
COMMANDS: tuple[CommandRecord, ...] = (
    ...
    _r("CMD-CORE-006", "./scripts/agent <command>", "Core runtime", "Run the local agent through the repo launcher, preferring .venv and the Codex Python runtime before system python3.", "./scripts/agent doctor", "active", "4 Tested", "SAFE", "TRUSTED_USER / MODEL_OUTPUT", "per delegated command", "command-specific", "command-specific", "delegates to smart_agent.py", "delegated command-specific", "delegated command-specific", "delegated command-specific", "startup ergonomics tests", "manual wrapper smoke passed", "README.md", "Use this on macOS to avoid Apple Python 3.9 crashes; the wrapper checks Python 3.11+ before launching.", introduced="2026-05-23"),
    ...
    _r("CMD-PRIVACY-001", "python smart_agent.py privacy status", "Privacy", "Show high-level metadata-only privacy status.", "python smart_agent.py privacy status", "active", "4 Tested", "SAFE", "LOCAL_PRIVATE_DATA metadata", "no", "none", "none", "read metadata", "n/a", "privacy status audited", "memory counts only", "privacy tests", "manual QA pending", "README.md", introduced="2026-05-23"),
    _r("CMD-PRIVACY-002", "python smart_agent.py privacy inventory", "Privacy", "Show metadata-only data inventory.", "python smart_agent.py privacy inventory", "active", "4 Tested", "SAFE", "LOCAL_PRIVATE_DATA metadata", "no", "none", "none", "read metadata", "n/a", "privacy inventory audited", "memory/capture counts only", "privacy tests", "manual QA pending", "README.md", introduced="2026-05-23"),
    _r("CMD-PRIVACY-003", "python smart_agent.py privacy export", "Privacy", "Export redacted local privacy report.", "python smart_agent.py privacy export", "active", "4 Tested", "LOW", "LOCAL_PRIVATE_DATA metadata", "no", "none", "none", "read redacted local stores", "n/a", "privacy export audited", "redacted memory previews only", "privacy tests", "manual QA pending", "README.md", introduced="2026-05-23"),
    _r("CMD-PRIVACY-004", "python smart_agent.py privacy delete-memory --confirm DELETE-MEMORY", "Privacy", "Clear local memory through brokered memory.clear after confirmation.", "python smart_agent.py privacy delete-memory --scope default --confirm DELETE-MEMORY", "active", "4 Tested", "MEDIUM", "TRUSTED_USER", "confirmation required", "memory", "sqlite", "memory delete", "yes via memory.clear", "privacy request and memory.clear audited", "deletes memory scope", "privacy tests", "manual QA with caution", "README.md", introduced="2026-05-23"),
    _r("CMD-PRIVACY-005", "python smart_agent.py privacy audit-summary", "Privacy", "Summarize audit metadata without raw args.", "python smart_agent.py privacy audit-summary", "active", "4 Tested", "SAFE", "Audit metadata", "no", "none", "none", "read audit metadata", "n/a", "summary request audited", "no memory write", "privacy tests", "manual QA pending", "README.md", introduced="2026-05-23"),
    _r("CMD-PRIVACY-006", "python smart_agent.py privacy permissions", "Privacy", "Show permission grants plus personal/high/critical capability rules.", "python smart_agent.py privacy permissions", "active", "4 Tested", "SAFE", "LOCAL_PRIVATE_DATA metadata", "no", "none", "none", "read permission/capability metadata", "n/a", "permissions summary audited", "no memory write", "privacy tests", "manual QA pending", "README.md", introduced="2026-05-23"),
    ...
    _r("CMD-SKILLS-001", "python smart_agent.py skills vet <path>", "Native skills", "Vet a workspace SKILL.md file without executing external code.", "python smart_agent.py skills vet ./workspace/skills/example/SKILL.md", "active", "4 Tested", "LOW", "UNTRUSTED_DOCUMENT", "no", "native_skills", "none", "workspace read only", "yes via native_skills.vet_skill_file", "vetting audited", "no memory write", "native skills vetter tests", "manual QA pending", "docs/native_skills/SKILL_INTAKE_PROCESS.md", introduced="2026-05-23"),
    _r("CMD-SKILLS-002", "python smart_agent.py skills vet-folder <path>", "Native skills", "Vet a workspace skill folder and inventory scripts/binaries without executing them.", "python smart_agent.py skills vet-folder ./workspace/skills/example", "active", "4 Tested", "LOW", "UNTRUSTED_DOCUMENT", "no", "native_skills", "none", "workspace read only", "yes via native_skills.vet_skill_folder", "vetting audited", "no memory write", "native skills vetter tests", "manual QA pending", "docs/native_skills/SKILL_INTAKE_PROCESS.md", introduced="2026-05-23"),
    _r("CMD-SKILLS-003", "python smart_agent.py skills score <path>", "Native skills", "Return a compact risk score for a workspace skill candidate.", "python smart_agent.py skills score ./workspace/skills/example/SKILL.md", "active", "4 Tested", "LOW", "UNTRUSTED_DOCUMENT", "no", "native_skills", "none", "workspace read only", "yes via native_skills.score_candidate", "scoring audited", "no memory write", "native skills vetter tests", "manual QA pending", "docs/native_skills/SKILL_INTAKE_PROCESS.md", introduced="2026-05-23"),
    _r("CMD-SKILLS-004", "python smart_agent.py skills list", "Native skills", "List metadata-only native skill manifests.", "python smart_agent.py skills list", "active", "3 Implemented", "SAFE", "Skill metadata", "no", "native_skills", "none", "read metadata", "metadata only", "none", "no memory write", "native skill manifest tests", "manual QA pending", "docs/native_skills/NATIVE_SKILLS_PROGRAM.md", introduced="2026-05-23"),
    _r("CMD-SKILLS-005", "python smart_agent.py skills show <skill_id>", "Native skills", "Show one native skill manifest without executing it.", "python smart_agent.py skills show native_skill_vetter", "active", "3 Implemented", "SAFE", "Skill metadata", "no", "native_skills", "none", "read metadata", "metadata only", "none", "no memory write", "native skill manifest tests", "manual QA pending", "docs/native_skills/NATIVE_SKILLS_PROGRAM.md", introduced="2026-05-23"),
    _r("CMD-SKILLS-006", "python smart_agent.py skills validate", "Native skills", "Validate native skill manifests against policy/capability rules.", "python smart_agent.py skills validate", "active", "4 Tested", "SAFE", "Skill metadata", "no", "native_skills", "none", "read metadata", "metadata only", "none", "no memory write", "native skill manifest tests", "manual QA pending", "docs/native_skills/NATIVE_SKILLS_PROGRAM.md", introduced="2026-05-23"),
    _r("CMD-SKILLS-007", "python smart_agent.py skills doctor", "Native skills", "Check native skill discovery and validation status.", "python smart_agent.py skills doctor", "active", "4 Tested", "SAFE", "Skill metadata", "no", "native_skills", "none", "read metadata", "metadata only", "none", "no memory write", "native skill manifest tests", "manual QA pending", "docs/native_skills/NATIVE_SKILLS_PROGRAM.md", introduced="2026-05-23"),
    _r("CMD-SKILLS-008", "python smart_agent.py skills find \"<query>\"", "Native skills", "Find implemented or planned native skills from local manifests and reviewed candidate docs.", "python smart_agent.py skills find \"I need to work with PDFs\"", "active", "4 Tested", "LOW", "UNTRUSTED_DOCUMENT metadata", "no", "native_skills", "none", "read local skill docs only", "yes via native_skills.find_skill", "search audited with files read", "no memory write", "native skill finder tests", "manual QA pending", "docs/native_skills/NATIVE_SKILLS_PROGRAM.md", introduced="2026-05-23"),
    ...
    _r("CMD-SESSION-002", "python smart_agent.py session status", "Session logging", "Show the active session and storage path.", "python smart_agent.py session status", "active", "4 Tested", "SAFE", "TRUSTED_USER metadata", "no", "session logging", "none", "read session metadata", "n/a", "none", "no memory write", "session logging tests", "manual QA pending", "docs/SESSION_LOGGING.md", introduced="2026-05-23"),
    _r("CMD-SESSION-003", "python smart_agent.py session run -- <command args>", "Session logging", "Run a smart_agent.py command and append redacted output to the active session.", "python smart_agent.py session run -- --no-tools \"Explain RCS vs iMessage\"", "active", "4 Tested", "LOW/HIGH", "command-specific plus redacted output", "command-dependent", "session logging", "none", "delegated command plus redacted output write", "delegated command-specific", "links detected audit ids where present", "no memory write by session logger", "session logging tests", "manual dogfood QA pending", "docs/SESSION_LOGGING.md", "Delegated command retains its own ToolBroker/policy/approval/audit behavior.", introduced="2026-05-23"),
    _r("CMD-SESSION-004", "python smart_agent.py session end", "Session logging", "End the active session log.", "python smart_agent.py session end", "active", "4 Tested", "LOW", "TRUSTED_USER metadata", "no", "session logging", "none", "session metadata write", "n/a", "session lifecycle metadata recorded", "no memory write", "session logging tests", "manual QA pending", "docs/SESSION_LOGGING.md", introduced="2026-05-23"),
    ...
    _r("CMD-SESSION-006", "python smart_agent.py session show <session_id>", "Session logging", "Show one redacted session record and command previews.", "python smart_agent.py session show sess_20260523T120000Z_abcd1234", "active", "4 Tested", "LOW", "redacted session output", "no", "session logging", "none", "read redacted session log", "n/a", "none", "no memory write", "session logging tests", "manual QA pending", "docs/SESSION_LOGGING.md", introduced="2026-05-23"),
    _r("CMD-SESSION-007", "python smart_agent.py session replay <session_id>", "Session logging", "Render a redacted session replay.", "python smart_agent.py session replay --last", "active", "4 Tested", "LOW", "redacted session output", "no", "session logging", "none", "read redacted session log", "n/a", "none", "no memory write", "session logging tests", "manual QA pending", "docs/SESSION_LOGGING.md", introduced="2026-05-23"),
    _r("CMD-SESSION-008", "python smart_agent.py session export <session_id>", "Session logging", "Export one redacted session record as JSON.", "python smart_agent.py session export sess_20260523T120000Z_abcd1234", "active", "4 Tested", "LOW", "redacted session output", "no", "session logging", "none", "read redacted session log", "n/a", "none", "no memory write", "session logging tests", "manual QA pending", "docs/SESSION_LOGGING.md", introduced="2026-05-23"),
    _r("CMD-SESSION-009", "python smart_agent.py session last", "Session logging", "Show the last active or ended session.", "python smart_agent.py session last", "active", "4 Tested", "SAFE", "TRUSTED_USER metadata", "no", "session logging", "none", "read session metadata", "n/a", "none", "no memory write", "session logging tests", "manual QA pending", "docs/SESSION_LOGGING.md", introduced="2026-05-23"),
    _r("CMD-SESSION-010", "python smart_agent.py session review <session_id>", "Session logging", "Analyze redacted session commands, feedback, failures, and audit links into a structured review.", "python smart_agent.py session review --last", "active", "4 Tested", "LOW", "redacted session output / TRUSTED_USER feedback", "no", "session logging", "none", "read redacted session log and write review report", "n/a", "session review audited", "no memory write", "session review tests", "manual dogfood review pending", "docs/BUG_TRIAGE.md", "Uses redacted previews and feedback only; does not read raw personal connector data or fix bugs.", introduced="2026-05-23"),
    _r("CMD-SESSION-011", "python smart_agent.py session review --last --create-bugs", "Session logging", "Analyze the latest redacted session and write local candidate bug reports.", "python smart_agent.py session review --last --create-bugs", "active", "4 Tested", "LOW", "redacted session output / TRUSTED_USER feedback", "no", "session logging", "none", "read redacted session log and write redacted bug files", "n/a", "session review and bug creation audited", "no memory write", "session review tests", "manual dogfood review pending", "docs/BUG_TRIAGE.md", "Bug records are local triage artifacts, not auto-fixes.", introduced="2026-05-23"),
    _r("CMD-BUGS-001", "python smart_agent.py bugs list", "Dogfood", "List redacted local bug reports generated from session reviews.", "python smart_agent.py bugs list", "active", "4 Tested", "SAFE", "redacted bug metadata", "no", "session logging", "none", "read bug metadata", "n/a", "bugs list audited", "no memory write", "session review tests", "manual QA pending", "docs/BUG_TRIAGE.md", introduced="2026-05-23"),
    _r("CMD-BUGS-002", "python smart_agent.py bugs show <bug_id>", "Dogfood", "Show one redacted local bug report.", "python smart_agent.py bugs show BUG-0001", "active", "4 Tested", "LOW", "redacted bug report", "no", "session logging", "none", "read bug file", "n/a", "bugs show audited", "no memory write", "session review tests", "manual QA pending", "docs/BUG_TRIAGE.md", introduced="2026-05-23"),
    _r("CMD-BUGS-003", "python smart_agent.py bugs export", "Dogfood", "Export all redacted local bug reports.", "python smart_agent.py bugs export", "active", "4 Tested", "LOW", "redacted bug reports", "no", "session logging", "none", "read bug files", "n/a", "bugs export audited", "no memory write", "session review tests", "manual QA pending", "docs/BUG_TRIAGE.md", introduced="2026-05-23"),
    _r("CMD-DOGFOOD-001", "python smart_agent.py dogfood list", "Dogfood", "List curated manual dogfood command suites.", "python smart_agent.py dogfood list", "active", "4 Tested", "SAFE", "Suite metadata", "no", "dogfood", "none", "read suite YAML", "n/a", "none", "no memory write", "dogfood suite tests", "manual QA pending", "docs/dogfood/DOGFOOD_GUIDE.md", introduced="2026-05-23"),
    _r("CMD-DOGFOOD-002", "python smart_agent.py dogfood show <suite>", "Dogfood", "Show one dogfood suite with prerequisites, expected behavior, and failure signals.", "python smart_agent.py dogfood show all_safe", "active", "4 Tested", "SAFE", "Suite metadata", "no", "dogfood", "none", "read suite YAML", "n/a", "none", "no memory write", "dogfood suite tests", "manual QA pending", "docs/dogfood/COMMAND_SUITES.md", introduced="2026-05-23"),
    _r("CMD-DOGFOOD-003", "python smart_agent.py dogfood run <suite>", "Dogfood", "Run a curated suite and continue through failures with a structured summary.", "python smart_agent.py dogfood run all_safe", "active", "4 Tested", "LOW/MEDIUM", "Tool-specific", "suite-dependent", "dogfood", "suite-dependent", "delegated command execution", "delegated command-specific", "delegated command-specific", "delegated command-specific", "dogfood runner tests", "manual QA pending", "docs/dogfood/DOGFOOD_GUIDE.md", "Commands are constrained to python smart_agent.py and keep underlying policy/ToolBroker behavior.", introduced="2026-05-23"),
    _r("CMD-DOGFOOD-004", "python smart_agent.py dogfood run <suite> --session", "Dogfood", "Run a dogfood suite through the active redacted session logger.", "python smart_agent.py session start --name dogfood && python smart_agent.py dogfood run all_safe --session", "active", "4 Tested", "LOW/MEDIUM", "Tool-specific plus redacted output", "suite-dependent", "dogfood/session logging", "suite-dependent", "delegated command plus redacted session output write", "delegated command-specific", "session command records may link audit ids", "no memory write by dogfood runner", "dogfood session integration tests", "manual QA pending", "docs/dogfood/DOGFOOD_GUIDE.md", "Requires an active session; does not create hidden background logging.", introduced="2026-05-23"),
    _r("CMD-DOGFOOD-005", "python smart_agent.py dogfood run <suite> --dry-run", "Dogfood", "Preview dogfood suite commands without executing them.", "python smart_agent.py dogfood run personal_dry_run --dry-run", "active", "4 Tested", "SAFE", "Suite metadata", "no", "dogfood", "none", "read suite YAML", "n/a", "none", "no memory write", "dogfood runner tests", "manual QA pending", "docs/dogfood/DOGFOOD_GUIDE.md", introduced="2026-05-23"),
    _r("CMD-FEEDBACK-001", "python smart_agent.py feedback good --last", "Feedback", "Attach positive redacted feedback to the last session command.", "python smart_agent.py feedback good --last", "active", "4 Tested", "LOW", "TRUSTED_USER", "no", "session logging", "none", "feedback metadata write", "n/a", "feedback add audited", "no memory write", "session feedback tests", "manual QA pending", "docs/SESSION_LOGGING.md", introduced="2026-05-23"),
    _r("CMD-FEEDBACK-002", "python smart_agent.py feedback bad --last --reason \"...\"", "Feedback", "Attach negative redacted feedback to the last session command.", "python smart_agent.py feedback bad --last --reason \"too vague\"", "active", "4 Tested", "LOW", "TRUSTED_USER", "no", "session logging", "none", "feedback metadata write", "n/a", "feedback add audited", "no memory write", "session feedback tests", "manual QA pending", "docs/SESSION_LOGGING.md", introduced="2026-05-23"),
    _r("CMD-FEEDBACK-003", "python smart_agent.py feedback bug --last --title \"...\"", "Feedback", "Mark the last session command as buggy and create a linked bug placeholder id.", "python smart_agent.py feedback bug --last --title \"weather command crashed\"", "active", "4 Tested", "LOW", "TRUSTED_USER", "no", "session logging", "none", "feedback metadata write", "n/a", "feedback add audited", "no memory write", "session feedback tests", "manual QA pending", "docs/SESSION_LOGGING.md", introduced="2026-05-23"),
    _r("CMD-FEEDBACK-004", "python smart_agent.py feedback confusing --last --reason \"...\"", "Feedback", "Mark the last session command as confusing.", "python smart_agent.py feedback confusing --last --reason \"approval wording was unclear\"", "active", "4 Tested", "LOW", "TRUSTED_USER", "no", "session logging", "none", "feedback metadata write", "n/a", "feedback add audited", "no memory write", "session feedback tests", "manual QA pending", "docs/SESSION_LOGGING.md", introduced="2026-05-23"),
    _r("CMD-FEEDBACK-005", "python smart_agent.py feedback slow --last --reason \"...\"", "Feedback", "Mark the last session command as too slow.", "python smart_agent.py feedback slow --last --reason \"took too long\"", "active", "4 Tested", "LOW", "TRUSTED_USER", "no", "session logging", "none", "feedback metadata write", "n/a", "feedback add audited", "no memory write", "session feedback tests", "manual QA pending", "docs/SESSION_LOGGING.md", introduced="2026-05-23"),
    _r("CMD-FEEDBACK-006", "python smart_agent.py feedback unsafe --last --reason \"...\"", "Feedback", "Mark the last session command as unsafe, escalating severity.", "python smart_agent.py feedback unsafe --last --reason \"revealed private data\"", "active", "4 Tested", "LOW", "TRUSTED_USER", "no", "session logging", "none", "feedback metadata write", "n/a", "feedback add audited", "no memory write", "session feedback tests", "manual QA pending", "docs/SESSION_LOGGING.md", introduced="2026-05-23"),
    _r("CMD-FEEDBACK-007", "python smart_agent.py feedback rate --last --score 1-5", "Feedback", "Attach a numeric 1-5 rating to the last session command.", "python smart_agent.py feedback rate --last --score 4", "active", "4 Tested", "LOW", "TRUSTED_USER", "no", "session logging", "none", "feedback metadata write", "n/a", "feedback add audited", "no memory write", "session feedback tests", "manual QA pending", "docs/SESSION_LOGGING.md", introduced="2026-05-23"),
    _r("CMD-FEEDBACK-008", "python smart_agent.py feedback add <command_id> --tag <tag> --note \"...\"", "Feedback", "Attach custom tagged feedback to a specific session command id.", "python smart_agent.py feedback add cmd_123 --tag poor_response --note \"missed citation\"", "active", "4 Tested", "LOW", "TRUSTED_USER", "no", "session logging", "none", "feedback metadata write", "n/a", "feedback add audited", "no memory write", "session feedback tests", "manual QA pending", "docs/SESSION_LOGGING.md", introduced="2026-05-23"),
    _r("CMD-FEEDBACK-009", "python smart_agent.py feedback list --session <session_id>", "Feedback", "List redacted feedback records for a session.", "python smart_agent.py feedback list --session sess_20260523T120000Z_abcd1234", "active", "4 Tested", "SAFE", "TRUSTED_USER metadata", "no", "session logging", "none", "read feedback metadata", "n/a", "feedback list audited", "no memory write", "session feedback tests", "manual QA pending", "docs/SESSION_LOGGING.md", introduced="2026-05-23"),
    _r("CMD-FEEDBACK-010", "python smart_agent.py feedback export --session <session_id>", "Feedback", "Export redacted feedback records for a session.", "python smart_agent.py feedback export --session sess_20260523T120000Z_abcd1234", "active", "4 Tested", "SAFE", "TRUSTED_USER metadata", "no", "session logging", "none", "read feedback metadata", "n/a", "feedback list audited", "no memory write", "session feedback tests", "manual QA pending", "docs/SESSION_LOGGING.md", introduced="2026-05-23"),
    ...
    _r("CMD-BACKUP-001", "python smart_agent.py backup create", "Backup", "Create a redacted local backup archive with manifest and integrity hash.", "python smart_agent.py backup create", "active", "4 Tested", "MEDIUM", "LOCAL_PRIVATE_DATA", "no", "backup", "none", "archive write", "yes via backup.create", "backup create audited", "no memory write; redacted memory export only", "backup/restore tests", "manual QA pending", "README.md#backup--restore", introduced="2026-05-23"),
    _r("CMD-BACKUP-002", "python smart_agent.py backup list", "Backup", "List local backup archives without reading personal connectors.", "python smart_agent.py backup list", "active", "4 Tested", "LOW", "LOCAL_PRIVATE_DATA metadata", "no", "backup", "none", "read manifests", "yes via backup.list", "backup list audited", "no memory write", "backup/restore tests", "manual QA pending", "README.md#backup--restore", introduced="2026-05-23"),
    _r("CMD-BACKUP-003", "python smart_agent.py backup inspect <backup_id>", "Backup", "Inspect a backup manifest and restore preview.", "python smart_agent.py backup inspect backup_20260523T000000Z_abcd1234", "active", "4 Tested", "LOW", "LOCAL_PRIVATE_DATA metadata", "no", "backup", "none", "read manifest", "yes via backup.inspect", "backup inspect audited", "no memory write", "backup/restore tests", "manual QA pending", "README.md#backup--restore", introduced="2026-05-23"),
    _r("CMD-BACKUP-004", "python smart_agent.py backup verify <backup_id>", "Backup", "Verify backup manifest and file hashes.", "python smart_agent.py backup verify backup_20260523T000000Z_abcd1234", "active", "4 Tested", "LOW", "LOCAL_PRIVATE_DATA metadata", "no", "backup", "none", "read manifest/files", "yes via backup.verify", "backup verify audited", "no memory write", "backup/restore tests", "manual QA pending", "README.md#backup--restore", introduced="2026-05-23"),
    _r("CMD-BACKUP-005", "python smart_agent.py backup export --redacted", "Backup", "Create a portable redacted backup export; unredacted export is unsupported in v1.", "python smart_agent.py backup export --redacted", "active", "4 Tested", "MEDIUM", "LOCAL_PRIVATE_DATA", "no", "backup", "none", "archive write", "yes via backup.export", "backup export audited", "no memory write; redacted memory export only", "backup/restore tests", "manual QA pending", "README.md#backup--restore", introduced="2026-05-23"),
    _r("CMD-BACKUP-006", "python smart_agent.py backup restore <backup_id>", "Backup", "Restore a backup after approval, hash verification, and policy-weakening checks.", "python smart_agent.py backup restore backup_20260523T000000Z_abcd1234", "active", "4 Tested", "HIGH", "LOCAL_PRIVATE_DATA", "yes", "backup", "none", "workspace/config/docs writes", "yes via backup.restore", "backup restore approvals and execution audited", "restores redacted memory/action metadata exports only", "backup/restore tests", "manual QA with test backup only", "README.md#backup--restore", introduced="2026-05-23"),
)
...
def _regression_path(record: CommandRecord) -> str:
    ...
    if "self-improvement" in group:
        return "tests/test_self_improvement.py"
    if "file" in group:
        return "tests/test_files_workflow.py"
    if "pdf" in group or "document" in group:
        return "tests/test_pdf_documents.py"
